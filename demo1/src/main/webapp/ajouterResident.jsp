...
<html>
<head>
    <title>Ajouter un résident</title>
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form action="AjouterResidentServlet" method="post" enctype="multipart/form-data">
                ...
                <input type="number" id="chambre_id" name="chambre_id" required><br>
