    ...
    <main>
        ...
        <div class="header">
            ...
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Rechercher un technicien..." oninput="filterTechniciens()">
                <button type="button">
            ...
            <tbody>
                <%
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("SELECT * FROM techniciens");
                ...
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="modifierTechnicien.jsp?id=<%= id %>">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="SupprimerTechnicienServlet?id=<%= id %>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce technicien ?');">
        ...
        <div class="links-container">
            <a href="ajouterTechnicien.jsp" class="custom-button">Ajouter un technicien</a>
        </div>
    </main>
    ...
    <script>
        function filterTechniciens() {
            ...
            rows.forEach(row => {
                ...
                const specialite = row.cells[4].textContent.toLowerCase();

                if (nom.includes(input) || email.includes(input) || specialite.includes(input)) {
                    row.style.display = "";
                } else {
