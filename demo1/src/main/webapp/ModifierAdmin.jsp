...
<%@ page import="com.example.demo1.Admin" %>
...
<head>
    ...
    <style>
        ...
        main {
            ...
            align-items: flex-start; /* Début en haut */
    ...
    <main>
        <div class="container">
            ...
            <form action="modifierAdmin" method="post">
                ...
                <input type="password" id="password" name="password" value="<%= admin.getPassword() %>" required><br>

                <button type="submit">Modifier</button>
            </form>
            <%
                } else {
                    out.println("<p>Administrateur non trouvé.</p>");
                }
            %>
            <a href="listeAdmin.jsp">Retour à la liste</a>
        </div>
    </main>
</body>
</html>