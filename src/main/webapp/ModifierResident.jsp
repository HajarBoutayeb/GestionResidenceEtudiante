...
<html>
<head>
    <title>Modifier un résident</title>
    ...
    <main>
        <div class="container">
            ...
            <%
                ...
                String nom = "", prenom = "", CNE = "", email = "", motDePasse = "", statut = "", carteEtudiant = "";
                int chambreId = 0;
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        carteEtudiant = rs.getString("carte_etudiant");
                    }
            ...
            %>
            <form action="ModifierResidentServlet" method="post" enctype="multipart/form-data">
                ...
                <input type="text" id="CNE" name="CNE" value="<%= CNE %>" required><br>
                ...
                <input type="number" id="chambre_id" name="chambre_id" value="<%= chambreId %>" required><br>

                <label for="statut">Statut:</label>
                <select id="statut" name="statut">
                    <option value="actif" <% if (statut.equals("actif")) out.print("selected"); %>>Actif</option>
                    <option value="parti" <% if (statut.equals("parti")) out.print("selected"); %>>Parti</option>
                    <option value="en attente" <% if (statut.equals("en attente")) out.print("selected"); %>>En attente</option>
                </select><br>

                <label for="carte_etudiant">Carte étudiant:</label>
                <input type="file" id="carte_etudiant" name="carte_etudiant" accept=".pdf,.jpg,.jpeg,.png"><br>

                <% if (carteEtudiant != null && !carteEtudiant.isEmpty()) { %>
                    <p>
                        <a href="<%= carteEtudiant %>" class="download-link" download>
                            <i class="fas fa-download"></i> Télécharger la carte d'étudiant actuelle
                        </a>
                    </p>
                <% } %>
            ...
            <a href="indexResidents.jsp">Retour à la liste</a>
        </div>
    </main>
</body>
</html>