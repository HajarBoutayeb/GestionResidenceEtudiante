...
<main>
    <div class="header">
        ...
        <div class="search-bar">
            <input type="text" id="searchInput" placeholder="Rechercher un administrateur..." oninput="filterAdmins()">
            <button type="button">
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td class="action-buttons">
                <a href="modifierAdmin?id=<%= id %>"> <!-- Correction de l'URL -->
                    <i class="fas fa-edit"></i>
                </a>
                <a href="SupprimerAdminServlet?id=<%= id %>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet administrateur ?');">
    ...
    <div class="links-container">
        <a href="ajouterAdmin.jsp" class="custom-button">Ajouter un administrateur</a>
    </div>
</main>
