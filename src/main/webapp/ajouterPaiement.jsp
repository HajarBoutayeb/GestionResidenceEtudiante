...
<head>
    ...
    <style>
        ...
        main {
            ...
            margin-left: 50px; /* Éloigner du menu latéral */
...
<main>
    <div class="container">
        ...
        <form action="AjouterPaiementServlet" method="post" enctype="multipart/form-data">
            <label for="id_etudiant">ID Étudiant:</label>
            <input type="number" id="id_etudiant" name="id_etudiant" required><br>

            <label for="montant_paye">Montant Payé:</label>
            <input type="number" step="0.01" id="montant_paye" name="montant_paye" required><br>
        ...
        <a href="listePaiements.jsp">Retour à la liste</a>
    </div>
</main>
</body>
</html>