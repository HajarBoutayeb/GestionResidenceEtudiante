...
<head>
    ...
    <style>
        ...
        * {
        ...
        aside {
            width: 250px;
            background: #3b5bdb; /* Couleur de fond */
            color: white;
            padding: 20px;
...
<aside id="sidebar">
    <div class="top">
        ...
        <div class="close" id="close-btn">
            <i class="fas fa-chevron-left"></i> <!-- Icône de fermeture -->
        </div>
    </div>
    <div class="sidebar">
...
<div class="container">
    <div class="confirmation-container">
        ...
        <h1>Administrateur Ajouté</h1>
        <p>Le nouvel administrateur a été ajouté avec succès.</p>
