...
public class PaiementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (residentId == null) {
            response.sendRedirect("loginResident.jsp"); // Rediriger vers la page de connexion si l'utilisateur n'est pas connecté
            return;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ServletException {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
                ...
                response.sendRedirect("paiementResident.jsp"); // Rediriger vers la page des paiements
            }
